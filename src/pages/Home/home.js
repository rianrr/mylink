...
import { ContainerLogo, Logo, ContainerContent, Title, SubTitle, ContainerInput, BoxIcon, Input, ButtonLink, ButtonLinkText } from './homeStyle';
...
export default function Home() {
    ...
    async function handleShortLink() {
        ...
        try {
            ...
            // Deu tudo certo, mas preciso salvar este link em uma lista nesse storage.
